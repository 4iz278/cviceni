...
class UsersModel implements Authenticator{
  ...
  public function findAll():array {
    $query=$this->pdo->prepare('SELECT * FROM mvc_users');
    $query->execute();
  ...
  public function findById(int $id):User {
    $query=$this->pdo->prepare('SELECT * FROM mvc_users WHERE id=:id LIMIT 1;');
    $query->execute([':id'=>$id]);
  ...
  public function findByEmail(string $email):User {
    $query=$this->pdo->prepare('SELECT * FROM mvc_users WHERE email=:email LIMIT 1;');
  ...
  public function delete(User|int $id):bool{
    ...
    $query=$this->pdo->prepare('DELETE FROM mvc_users WHERE id=:id LIMIT 1;');
