...
--
-- Struktura tabulky `mvc_articles`
--
...
--
-- Vypisuji data pro tabulku `mvc_articles`
--

INSERT INTO `mvc_articles` (`id`, `title`, `perex`, `content`, `category`, `author`, `last_modified`) VALUES
...
--
-- Struktura tabulky `mvc_categories`
--
...
--
-- Vypisuji data pro tabulku `mvc_categories`
--

INSERT INTO `mvc_categories` (`id`, `name`, `order`) VALUES
(1, 'Vtipy', 1),
(2, 'Novinky', 0),
(3, 'Poznámky', 2);
...
--
-- Struktura tabulky `mvc_resources`
--

CREATE TABLE IF NOT EXISTS `mvc_resources` (
...
--
-- Vypisuji data pro tabulku `mvc_resources`
--

INSERT INTO `mvc_resources` (`role`, `resource`, `action`) VALUES
('admin', 'category', ''),
('admin', 'user', ''),
('editor', 'article', ''),
('editor', 'comment', ''),
...
--
-- Vypisuji data pro tabulku `mvc_roles`
--

INSERT INTO `mvc_roles` (`id`, `parent_id`) VALUES
('guest', NULL),
('admin', 'editor'),
('registered', 'guest'),
('editor', 'registered');
...
--
-- Vypisuji data pro tabulku `mvc_users`
--

INSERT INTO `mvc_users` (`id`, `name`, `email`, `password`, `role`, `active`) VALUES
...
--
-- Omezení pro tabulku `mvc_articles`
--
ALTER TABLE `mvc_articles`
  ADD CONSTRAINT `articleCategory` FOREIGN KEY (`category`) REFERENCES `mvc_categories` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `articleUser` FOREIGN KEY (`author`) REFERENCES `mvc_users` (`id`) ON UPDATE CASCADE;

--
-- Omezení pro tabulku `mvc_resources`
--
ALTER TABLE `mvc_resources`
  ADD CONSTRAINT `mvc_resources_ibfk_1` FOREIGN KEY (`role`) REFERENCES `mvc_roles` (`id`) ON UPDATE CASCADE;

--
-- Omezení pro tabulku `mvc_roles`
--
ALTER TABLE `mvc_roles`
  ADD CONSTRAINT `parentRole` FOREIGN KEY (`parent_id`) REFERENCES `mvc_roles` (`id`) ON UPDATE CASCADE;

--
-- Omezení pro tabulku `mvc_users`
--
ALTER TABLE `mvc_users`
  ADD CONSTRAINT `userRule` FOREIGN KEY (`role`) REFERENCES `mvc_roles` (`id`) ON UPDATE CASCADE;
