<?php
   ...
   * Pokud chceme objekt jako celek zkopírovat, používáme k tomu přiřazení s klíčovým slovem "clone". Poté je zavolána magická metoda __clone, která může vytvořit kopie (klony) také od vnořených objektů. Properties s čísly a řetězci jsou naklonovány automaticky.
   */
  ...
  class Trida2{
    ...
    function __clone():void{
      ...
      $this->vnorenyObjekt = clone $this->vnorenyObjekt;
