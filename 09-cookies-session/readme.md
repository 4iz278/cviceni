...
- postup zprovoznění ukázkové aplikace:
    1. stáhněte si celou složku aplikace ([06-app-eshop](09-app-eshop)) a nahrajte ji na server
    2. nahrajte do MariaDB [strukturu databáze](09-app-eshop/schema.sql)
    3. nahrajte do MariaDB [ukázková data](09-app-eshop/data.sql)
